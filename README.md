...
4. Start the frontend (open `Frontend/index.html` with VS Code Live Server or any static server). The frontend is configured to use `http://127.0.0.1:5500` as origin; the backend CORS allows that origin by default.
